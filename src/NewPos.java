...
public class NewPos implements Runnable  {
	...
	Particule [] elements;
	int numero; // pour l'instant une thread= calcul pos une particule, plus tard faire num 1 , num 2 et i va de num 1 √† num 2
	double pas;
	//on doit faire un saut de pointeur ensuite
	
	// calcule l'ensemble des forces s'appliquant √† une particule de num√©ro=numero, 
	//en remplissant son tableau de forces, et √©glament les forces que cette particule applique au reste
	...
	public void run ( ) {//lance les n petits threads
		...
		//initialisation de la premiËre ligne avec les forces puis du reste ‡ 0.
		//Remarque: ici en initialisant le tableau on perd l'avantage du parallÈlisme car l'initialisation est en  n*ln(n)
		...
		// puis faire postion aprËs cette somme
